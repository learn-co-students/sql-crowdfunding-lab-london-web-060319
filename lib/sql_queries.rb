...
"SELECT projects.category, SUM(pledges.amount) AS total_pledged FROM projects JOIN pledges ON projects.id = pledges.project_id WHERE projects.category = 'books'"
end
